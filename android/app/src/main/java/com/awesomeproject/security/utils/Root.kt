...
object Root {
    ...
    private fun checkRootMethod1(): Boolean {
        ...
        println("mouliTesting - checkRootMethod1 - testKeys: ${testKeys.decodeToString()}")
    ...
    private fun checkRootMethod2(): Boolean {
        ...
        println("mouliTesting - checkRootMethod2 - paths: ${paths.joinToString(", ")}")
        for (path in paths) {
    ...
    private fun checkRootMethod3(): Boolean {
        ...
        try {
            ...
            println("mouliTesting - checkRootMethod3 - ${arrayOf(which.decodeToString(), su.decodeToString()).joinToString(", ")}")
