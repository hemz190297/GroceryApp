...
export const MarketScreen = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.marketHeader}>Market</Text>
      <View style={styles.mainTabContainer}>
        <Text style={styles.mainTab}>New</Text>
        <Text style={styles.mainTab}>Indices</Text>
        <Text style={[styles.mainTab, styles.activeMainTab]}>Screeners</Text>
        <Text style={styles.mainTab}>News</Text>
        <Text style={styles.mainTab}>Event</Text>
      </View>
