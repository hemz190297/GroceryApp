...
const Home = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <Header
                leftIcon={require('../common/images/main-menu.png')}
                rightIcon={require('../common/images/menu.png')}
                title={'Grocery App'}
                onClickLeftIcon={() => navigation.openDrawer()}
                onClickRightIcon={() => navigation.navigate('CartListScreen')}
            />
            <FlatList
                data={product}
